...
การตอบสนองต่อการร้องขอการส่งออกเจ้าของข้อมูลสำหรับเกตเวย์ข้อมูลภายในองค์กรสามารถดูได้[ที่นี่](https://docs.microsoft.com/en-us/power-bi/service-gateway-onprem#tenant-level-administration)
